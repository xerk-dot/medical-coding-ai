...
class ConsensusValidator:
    ...
    def __init__(self):
        self.answer_key_file = "../question_banks/test_1/test_1_answers.json"
        self.consensus_reports_dir = "../consensus_benchmarks/consensus_reports"
        self.questions_file = "../question_banks/test_1/test_1_questions.json"
    ...
    def get_latest_consensus_report(self) -> Optional[str]:
        """Find the latest consensus report file"""
    ...
    def validate_consensus(self) -> List[ValidationResult]:
        """Validate the latest consensus report against the answer key"""
        # Load data
        ...
        # Get latest consensus report
        latest_report_file = self.get_latest_consensus_report()
        if not latest_report_file:
            print("❌ Cannot validate without consensus report")
            return []
        
        consensus_report = self.load_consensus_report(latest_report_file)
    ...
    def load_individual_test_results(self) -> Dict[str, Dict]:
        ...
        test_attempts_dir = "../test_attempts"
...
def main():
    ...
    # Validate consensus
    results = validator.validate_consensus()
