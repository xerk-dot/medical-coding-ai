...
### Output Locations
- **Test Results**: `../test_attempts/`
- **Consensus Reports**: `../consensus_benchmarks/consensus_reports/`
- **Validation Reports**: `../consensus_validation/`
...
cd ../code_embeddings && python fetch_embeddings.py
cd ../medical_board && python medical_test.py --all
```
...
Each test run now creates a new timestamped folder in `test_attempts/` with the format:
```
test_attempts/
